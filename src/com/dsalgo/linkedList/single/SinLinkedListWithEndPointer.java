...
public class SinLinkedListWithEndPointer extends SingleLinkedList {
    ...
    /* Constructor */
    public SinLinkedListWithEndPointer()
    {
        start = null;
        end = null;
        size = 0;
    ...
    public SinLinkedListWithEndPointer append(SinLinkedListWithEndPointer linkListToAppend) {
    ...
    public SinLinkedListWithEndPointer reverseHeadToTail() {
        if (this.isEmpty()) {
            return this;
        }
    ...
    public SinLinkedListWithEndPointer removeDuplicates() {
        if (this.isEmpty()) {
            return this;
        }
        Node ptr = this.start;
    ...
    public SinLinkedListWithEndPointer reverseLinkedList() {
        if (this.isEmpty()) {
            return this;
        }
